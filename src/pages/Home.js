    ...
    <div className='font-body'>
      <section id="home-section" className="h-screen">
        <div className='h-[800px] w-90 bg-lavendar rounded-[50px] mx-[13px] sm:mx-6 mt-[14px] mb-[70px] sm:mb-0 flex justify-center items-center flex-col'>
          ...
          <div className='w-95'>
            <p className='font-bold xl:text-[45px] md:text-[35px] text-[26px] mt-2 sm:mt-0 text-center text-wrap'>Hey, I'm Naa Shidaa,<br></br> an aspiring front-end developer.</p>
          </div>
          <div className='mt-[20px] md:text-[22px] text-[19px] sm:px-0 px-[10px] sm:mb-[100px] text-center'>
          ...
          <div className='flex sm:w-[420px] w-60 h-50 sm:h-full flex-col sm:flex-row static pt-[40px] sm:pt-[0px] pb-[20px] sm:pb-[0px] sm:justify-evenly'>
            ...
            <div className='border-white border-[17px] w-[75px] h-[75px] mx-auto sm:mx-0 rounded-[200px] '>
            ...
            <div className="flex flex-row justify-evenly">
              <div className='border-white border-[17px] w-[75px] h-[75px] rounded-[200px] '>
              <a href="https://github.com/RainaaNs" target="_blank" rel="noopener noreferrer">
                <img className='w-10 h-10' src={github} alt='Github' />
              </a>
              </div>
              <div className='border-white border-[17px] w-[75px] h-[75px] rounded-[200px] sm:hidden flex'>
              <a href="https://github.com/RainaaNs" target="_blank" rel="noopener noreferrer">
                <img className='w-10 h-10' src={github} alt='Github' />
              </a>
              </div>
        ...
        <section id="projects-section" className="mt-[10px] mb-[10px] md:mb-[70px] sm:mb-[40px] h-[100%] w-[100%]">
        <div className=''>
          <p className='font-bold text-[28px] sm:text-[32px] md:text-[40px] ml-[20px] sm:ml-[50px] my-[25px] leading-8 sm:leading-none '>Some Projects...</p>
        </div>
        <div className="border-2 md:mt-[10px] rounded-[50px] w-[100%] sm:w-[500px] md:w-[75%] lg:w-[70%] h-[72vh] sm:h-[75vh] mx-auto">
          <Carousel transitionTime={1000} showStatus={false} showIndicators={true} showArrows={false} infiniteLoop className='w-full h-[550px] sm:h-[600px] items-center mx-auto'>
            <div className='flex w-full h-[550px] sm:h-[600px] mx-auto'>
              ...
              <div className='absolute inset-0'>
                <p className='text-[26px] sm:text-[30px] font-semibold pt-10 sm:pt-4'>OpenFashion 2.0</p>
                <p className='text-[20px] sm:text-[23px]'>Fashion e-commerce platform</p>
            ...
            <div className='flex w-full h-[600px] mx-auto'>
              ...
              <div className='absolute inset-0'>
                <p className='text-[26px] sm:text-[30px] font-semibold pt-10 sm:pt-4'>Transactedd</p>
                <p className='text-[20px] sm:text-[23px] text-nowrap'>Transaction management app</p>
                <div className='absolute right-4 sm:right-12 top-[12%] sm:top-[15%] transform -translate-y-[100%]'>
            ...
            <div className='flex w-full h-[550px] mx-auto'>
              ...
              <div className='absolute inset-0'>
                <div className='absolute left-16 top-8'>
                  <p className='text-[26px] sm:text-[30px] font-semibold pt-2 sm:pt-[2px]'>Jobizz</p>
                  <p className='text-[20px] sm:text-[23px]'>Job search app</p>
                </div>
            ...
            <div className='flex w-full h-[600px] mx-auto'>
              ...
              <div className='absolute inset-0'>
                <p className='text-[26px] sm:text-[30px] font-semibold pt-10 sm:pt-4'>AquaNet</p>
                <p className='text-[20px] sm:text-[23px]'>Fish e-commerce platform</p>
                <div className='absolute right-4 sm:right-12 top-[12%] sm:top-[15%] transform -translate-y-[100%]'>
        ...
        <section id="contact-section" >
          <div className='h-[480px] sm:h-[500px] md:h-[550px] bg-mintcream rounded-[50px] mx-[13px] sm:mx-6 mt-5 mb-[40px] flex flex-col'>
            <div className='mt-[50px] mx-[18px] sm:mx-[30px] md:mx-[50px]'>
              <p className='font-bold font-lato text-[35px] sm:text-[43px] md:text-[50px]'>Let's chat<span className='text-red-700'>.</span></p>
              <p className='text-[20px] sm:text-[24px] md:text-[25px] text-wrap leading-7 sm:leading-normal'>Reach out through email or connect with me on social media - I'm just a message away.</p>

              <div className='flex flex-col sm:flex-row gap-4 w-[230px] sm:w-[470px] mt-[80px] sm:mt-[100px] md:mt-[192px]'>
                <div>
                  <EmailCopyButton/>
                </div>
